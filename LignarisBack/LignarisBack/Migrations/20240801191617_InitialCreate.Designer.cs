...
namespace LignarisBack.Migrations
{
    ...
    [Migration("20240801191617_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Cliente", b =>
                {
                    b.Property<int>("IdCliente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Compra", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.CompraDetalle", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Empleado", b =>
                {
                    b.Property<int>("IdEmpleado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Inventario", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.MateriaPrima", b =>
                {
                    b.Property<int>("IdMateriaPrima")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.MateriaProveedorIntermedium", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Persona", b =>
                {
                    b.Property<int>("IdPersona")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Produccion", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Proveedor", b =>
                {
                    b.Property<int>("IdProveedor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.RecetaDetalle", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Recetum", b =>
                {
                    b.Property<int>("IdReceta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.RegistroSesione", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.VentaDetalle", b =>
                {
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Ventum", b =>
                {
                    b.Property<int>("IdVenta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LignarisBack.Models.CarritoCompras", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.Cliente", "Cliente")
                        .WithMany("CarritoCompras")
                        .HasForeignKey("IdCliente")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Lignaris_Pizza_Backend.Models.Recetum", "Recetum")
                        .WithMany("CarritoCompras")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Cliente", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.Persona", "IdPersonaNavigation")
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Compra", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.Empleado", "IdEmpleadoNavigation")
                        .WithMany("Compras")
                        .HasForeignKey("IdEmpleado")
                        .IsRequired()
                        .HasConstraintName("fk_id_empleado_compra");

                    b.HasOne("Lignaris_Pizza_Backend.Models.Proveedor", "IdProveedorNavigation")
                        .WithMany("Compras")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.CompraDetalle", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.Compra", "IdCompraNavigation")
                        .WithMany("CompraDetalles")
                        .HasForeignKey("IdCompra")
                        .HasConstraintName("fk_id_compra_detalle");

                    b.HasOne("Lignaris_Pizza_Backend.Models.MateriaPrima", "IdMateriaPrimaNavigation")
                        .WithMany("CompraDetalles")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Inventario", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.CompraDetalle", "IdCompraDetalleNavigation")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Produccion", b =>
                {
                    ...
                    b.HasOne("Lignaris_Pizza_Backend.Models.Ventum", "IdVentaNavigation")
                        .WithMany("Produccions")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.RecetaDetalle", b =>
                {
                    ...
                    b.HasOne("Lignaris_Pizza_Backend.Models.Recetum", "IdRecetaNavigation")
                        .WithMany("RecetaDetalles")
            ...
            modelBuilder.Entity("Lignaris_Pizza_Backend.Models.Ventum", b =>
                {
                    b.HasOne("Lignaris_Pizza_Backend.Models.Cliente", "IdClienteNavigation")
                        .WithMany("Venta")
                        .HasForeignKey("IdCliente")
